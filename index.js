...
// 🌟 FIX UNIVERSEL VERCEL : Toujours utiliser path.resolve ou path.join pour l'infra Serverless
const publicPath = path.join(__dirname, 'public');
app.use(express.static(publicPath));

// Servir la landing page proprement
app.get('/', (req, res) => {
...
// 🌟 REQUIS POUR LE RUNTIME VERCEL DIRECT
const PORT = process.env.PORT || 3000;
if (process.env.NODE_ENV !== 'production') {
    app.listen(PORT, () => console.log(`Serveur démarré localement sur le port ${PORT}`));
}
